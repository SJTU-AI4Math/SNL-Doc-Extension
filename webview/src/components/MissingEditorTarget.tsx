...
const MESSAGES = defineUiMessages(
  'missingEditorTarget',
  {
    entry: 'Entry', macro: 'Macro', macroPackage: 'Macro Package', relationship: 'Relationship',
  ...
  {
    entry: '条目', macro: '宏', macroPackage: '宏包', relationship: '关系',
...
export type MissingEditorTargetKind =
  | 'entry' | 'macro' | 'macroPackage' | 'relationship' | 'entryKind' | 'macroKind';
