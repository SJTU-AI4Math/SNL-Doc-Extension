  ...
  for (const width of [320, 480, 1000]) {
    ...
    try {
      ...
      assert(
        ...
        measured.panel[2] === 'auto' && measured.panel[3] === 'hidden' && measured.panel[4] === measured.panel[5] &&
        measured.root[0] === measured.root[1],
        `ROOT-TEXT-CM:${width}`,
        measured
      );
