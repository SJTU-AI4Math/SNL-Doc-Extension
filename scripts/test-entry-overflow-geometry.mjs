  ...
  for (const width of [320, 240]) {
    ...
    try {
      ...
      assert(
        ...
        measured.targets.length > 0 && measured.targets[0][6] !== 'none' &&
        measured.wheel[1] > measured.wheel[0] && measured.wheel[2] === true &&
