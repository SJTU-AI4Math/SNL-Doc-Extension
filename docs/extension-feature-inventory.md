...
| CreateMacroPackage | Create Package / Update Package | button | `0.0.5` 在 `packages/` 写 manifest（Macro 实体在 `macros/`）；legacy workspace 使用 `term_macros/` | `create` / `update` | fileValid + name 非空 + 非 creating |
