...
const p=(entryId,line,endLine=line)=>{const pointer={mode:'lines',file:'Main.lean',line,endLine,...(entryId==='Demo'?{column:1,endColumn:2}:{})};const range={startLine:line,startColumn:1,endLine,endColumn:entryId==='Demo'?2:text.split('\n')[endLine-1].length+1,coveredEndLine:endLine};return {entryId,pointer,fileId:'f-one',sourceSha256:sha(bytes),range,inverseScope:compilePointerScope(pointer,range,text),status:'ok'};};
